Ext.define('RAWON.controller.dashboard',{
	extend	: 'Ext.app.Controller',
    init: function() {
        var me = this;
        me.getStore('RAWON.store.TreeStore');
        me.control({
    ...
    rubahPswd : function(button){
        var win = Ext.create('RAWON.module.GeneralSetup.Account.view.form.EditPswd');
        win.show();
    }, 
    rubah : function(btn){
        var me          = this;
        ...
        Ext.MessageBox.show({
            ...
            fn              : function(btn, evtObj){
                if (btn == 'yes') {
                    Ext.Ajax.request({
                        url     : BASE_URL + 'GeneralSetup/c_user/editPswd',
                        method  : 'POST',
                        params  : {
                            oldpswd     : oldpswd,
                            newpswd     : newpswd,
