Ext.define('RAWON.module.GeneralSetup.User.controller.Users', {
    extend  : 'Ext.app.Controller',
    CheckedDataEdit: [],

    init: function() {
        var me = this;
        me.getStore('RAWON.module.GeneralSetup.User.store.Users').load();
        me.control({
    ...
    reloadStore: function(){
        var me = this;
        me.getStore('RAWON.module.GeneralSetup.User.store.Users').reload();
    },
                    ...
                    Ext.Ajax.request({
                        ...
                        success         : function(response){
                            ...
                            if(data.msg === 1){
                                ...
                                var storeApproval = Ext.getStore('RAWON.module.GeneralSetup.User.store.Users');
        ...
        Ext.Ajax.request({
            ...
            success : function(response){
                ...
                if(data.total === 1){
                    ...
                    me.reset();
                    me.getStore('RAWON.module.GeneralSetup.User.store.Users').removeAll();
                    me.getStore('RAWON.module.GeneralSetup.User.store.Users').reload();
