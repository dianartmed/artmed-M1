Ext.define('RAWON.module.GeneralSetup.Role.view.form.FormRoleMenu', {
    extend      : 'Ext.window.Window',
    closeable   : true,
    modal       : true,
    requires    : ['RAWON.module.GeneralSetup.Role.store.ViewAllMenu'],
        ...
        me.items  = [
            {
                ...
                items       : [
                    ...
                    },
                    {
                        ...
                        fieldLabel  : 'Menu',
                        autoScroll  : false,
                        store       : Ext.create('RAWON.module.GeneralSetup.Role.store.ViewAllMenu'),
