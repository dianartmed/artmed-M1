Ext.define('RAWON.module.GeneralSetup.Role.view.grid.GridRoleMenu', {
    extend   : 'Ext.grid.Panel',
    store    : 'RAWON.module.GeneralSetup.Role.store.RoleMenu',
                            ...
                            if (btn == 'yes') {
                                Ext.Ajax.request({
                                    ...
                                    success         : function(response){
                                        ...
                                        var storeModul = Ext.getStore('RAWON.module.GeneralSetup.Role.store.RoleMenu');
