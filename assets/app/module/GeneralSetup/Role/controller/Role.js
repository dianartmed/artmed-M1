Ext.define('RAWON.module.GeneralSetup.Role.controller.Role', {
    extend  : 'Ext.app.Controller',
    CheckedDataEdit: [],

    init: function() {
        var me = this;
        me.getStore('RAWON.module.GeneralSetup.Role.store.Role').load();
        me.getStore('RAWON.module.GeneralSetup.Role.store.RoleMenu').load();
        me.control({
    ...
    reloadStore: function(){
        var me = this;
        me.getStore('RAWON.module.GeneralSetup.Role.store.Role').reload();
    },
    ...
    viewRole: function(grid, record, item, index, e, eOpts){
        ...
        Ext.Ajax.request({
            ...
            success         : function(response){
                ...
                var storeMenu = Ext.getStore('RAWON.module.GeneralSetup.Role.store.RoleMenu');
                storeMenu.removeAll();
                    ...
                    Ext.Ajax.request({
                        ...
                        success         : function(response){
                            ...
                            if(data.msg === 1){
                                ...
                                var storeApproval = Ext.getStore('RAWON.module.GeneralSetup.Role.store.Role');
        ...
        Ext.Ajax.request({
            ...
            success : function(response){
                ...
                if(data.total === 1){
                    ...
                    me.reset();
                    me.getStore('RAWON.module.GeneralSetup.Role.store.Role').removeAll();
                    me.getStore('RAWON.module.GeneralSetup.Role.store.Role').reload();
    ...
    addRole: function(grid, record, item, index, e, eOpts){
        ...
        if(record.data.id_role === '' || record.data.id_role === null)
        {
            ...
            this.getStore('RAWON.module.GeneralSetup.Role.store.ViewAllMenu').reload();      
            var win = Ext.create('RAWON.module.GeneralSetup.Role.view.form.FormRoleMenu');
            win.show();
        ...
        Ext.Ajax.request({
            ...
            success : function(response){
                ...
                if(data.total === 0){
                    ...
                    win.close();
                    var storeMenu = Ext.getStore('RAWON.module.GeneralSetup.store.RoleMenu');
                    storeMenu.removeAll();
                    storeMenu.add(data.data);
