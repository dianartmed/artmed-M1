Ext.define('RAWON.module.GeneralSetup.Menu.controller.Menu', {
    extend  : 'Ext.app.Controller',
    CheckedDataEdit: [],

    init: function() {
        var me = this;
        me.getStore('RAWON.module.GeneralSetup.Menu.store.Menu').load();
        me.control({
    ...
    reloadStore: function(){
        var me = this;
        me.getStore('RAWON.module.GeneralSetup.Menu.store.Menu').reload();
    },
                    ...
                    Ext.Ajax.request({
                        ...
                        success         : function(response){
                            ...
                            if(data.msg === 1){
                                ...
                                var storeApproval = Ext.getStore('RAWON.module.GeneralSetup.Menu.store.Menu');
        ...
        Ext.Ajax.request({
            ...
            success : function(response){
                ...
                if(data.total === 1){
                    ...
                    Ext.getCmp('formmenu').getForm().reset();
                    me.getStore('RAWON.module.GeneralSetup.Menu.store.Menu').removeAll();
                    me.getStore('RAWON.module.GeneralSetup.Menu.store.Menu').reload();
